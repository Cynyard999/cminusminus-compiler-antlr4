...
public enum ErrorType {
    ...
    // Calling Non-Array
    NON_ARRAY(10, "Not an array"),
    // Calling Non-Function
    NON_FUNC(11, "Not a function"),
    // Access Array with Non-Integer
    NON_INT(12, "Not an integer"),
    // Illegal Dot Used
    ILLEGAL_DOT(13, "Illegal use of DOT"),
    // Undefined Field
    UNDEF_FIELD(14, "Non-existent field"),
    // Redefined Field
    REDEF_FEILD(15, "Redefined field"),
    // Duplicate Structure Name
    DUPLIC_STRUCT(16,"Duplicated name"),
    // Undefined Structure
    UNDEF_STRUCT(17, "Undefined structure");
